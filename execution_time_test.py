...
def get_test_data(resize=True):
    ...
    images = [rf'data\SIDD_Small_sRGB_Only\Data\{filename}\GT_SRGB_010.PNG' for filename in img_filenames]
    noisy_images = [rf'data\SIDD_Small_sRGB_Only\Data\{filename}\NOISY_SRGB_010.PNG' for filename in img_filenames]
